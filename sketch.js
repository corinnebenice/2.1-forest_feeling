...
var temperaldensity = 4;
var borealdensity = 8;
var tropicaldensity = 6;
var subtropdensity = 3;
...
function setup() {
  ...
  fill(0);
  var alpha_a = 50;
  text("A", windowWidth * 0.005, alpha_a);
  text("B", windowWidth * 0.06, alpha_a);
  text("C", windowWidth * 0.13, alpha_a);
  text("D", windowWidth * 0.21, alpha_a);
  text("E", windowWidth * 0.24, alpha_a);
  text("F", windowWidth * 0.27, alpha_a);
  text("G", windowWidth * 0.30, alpha_a);
  text("H", windowWidth * 0.37, alpha_a);
  text("I", windowWidth * 0.39, alpha_a);
  text("J", windowWidth * 0.42, alpha_a);
  text("K", windowWidth * 0.44, alpha_a);
  text("L", windowWidth * 0.46, alpha_a);
  text("M", windowWidth * 0.50, alpha_a);
  text("N", windowWidth * 0.59, alpha_a);
  text("P", windowWidth * 0.64, alpha_a);
  text("R", windowWidth * 0.68, alpha_a);
  text("S", windowWidth * 0.705, alpha_a);
  text("T", windowWidth * 0.84, alpha_a);
  text("U", windowWidth * 0.88, alpha_a);
  text("V", windowWidth * 0.92, alpha_a);
  text("Y", windowWidth * 0.94, alpha_a);
  text("Z", windowWidth * 0.96, alpha_a);
...
function draw() {
  ...
  var perc_boreal = floor(map(amount_boreal, 0, total_amount, 0, blocksamount*borealdensity));
  var perc_temperal = floor(map(amount_temperal, 0, total_amount, 0, blocksamount*temperaldensity));
  var perc_tropical = floor(map(amount_tropical, 0, total_amount, 0, blocksamount*tropicaldensity));
  var perc_subtropical = floor(map(amount_subtrop, 0, total_amount, 0, blocksamount*subtropdensity));
